...
class BenchmarkTests(unittest.TestCase):
    def test_benchmark_generates_multilabel_metrics(self) -> None:
        ...
        self.assertIn("n_non_events", result.by_label.columns)
        self.assertIn("event_weight", result.by_label.columns)
        self.assertIn("eligible_for_aggregate", result.by_label.columns)
        self.assertIn("eligibility_reason", result.by_label.columns)
