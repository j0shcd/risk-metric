...
def _latest_snapshot(series: pd.DataFrame) -> Dict[str, Any]:
    ...
    if latest_row.empty:
        return {
            ...
            "dca_risk": None,
            "dca_model": {
                "top_reversal_component": None,
                "bottom_reversal_component": None,
                "cycle_extension_component": None,
                "cycle_regime_component": None,
    ...
    return {
        ...
        "dca_risk": _coerce_json_scalar(row.get("dca_risk")),
        "dca_model": {
            "top_reversal_component": _coerce_json_scalar(row.get("dca_top_reversal_component")),
            "bottom_reversal_component": _coerce_json_scalar(row.get("dca_bottom_reversal_component")),
            "cycle_extension_component": _coerce_json_scalar(row.get("dca_cycle_extension_component")),
            "cycle_regime_component": _coerce_json_scalar(row.get("dca_cycle_regime_component")),
            "component_coverage": _coerce_json_scalar(row.get("dca_component_coverage")),
        },
